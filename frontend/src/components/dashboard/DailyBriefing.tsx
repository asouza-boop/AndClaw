      ...
      <div className="p-5 relative z-10">
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-white tracking-tighter">Daily Copilot</h2>
              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-tertiary)', textTransform: 'none', display: 'block' }}>Strategic executive summary</span>
            </div>
          </div>
          <button 
        ...
        <section className="mb-8 p-6 rounded-2xl bg-white/[0.03] border border-white/5 relative overflow-hidden group/focus transition-premium hover:bg-white/[0.05]">
           ...
           <h4 className="mb-2 block" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-medium)', color: 'var(--color-text-tertiary)', textTransform: 'none', letterSpacing: '0.04em' }}>Focus do dia</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="flex items-center gap-2" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-medium)', color: 'var(--color-text-tertiary)', textTransform: 'none', letterSpacing: '0.04em' }}>
        ...
        <footer className="mt-8 pt-8 border-t border-white/5">
           <button 
             className="flex items-center justify-center transition-colors hover:bg-[var(--color-accent-hover)] cursor-pointer"
             style={{
               width: '100%',
               height: '48px',
